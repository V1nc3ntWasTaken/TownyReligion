...
public class PreReligionSetPublicEvent extends Event implements Cancellable {
	...
	public PreReligionSetPublicEvent(Religion religion, Town currentTown, boolean setPublic) {
