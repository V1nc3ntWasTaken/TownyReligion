...
public class PreReligionSetBoardEvent extends Event implements Cancellable {
	...
	public PreReligionSetBoardEvent(Religion religion, Town town, String newMessage) {
